                                ...
                                <CardContent>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p>
                                                {vehicle.fuelConsumptionRate
                                                    ? `${vehicle.fuelConsumptionRate} L/100km`
                                                    : "N/A"}
                                            </p>
                                        </div>
                                        <div>
                                    ...
                                    <div className="space-y-2">
                                        <div className="flex items-center justify-between">
                                            ...
                                            <span className="font-medium">
                                                {format(parseISO(vehicle.createdAt), "PP")}
                                            </span>
                                        </div>
                                        <div className="flex items-center justify-between">
                                            <span className="text-sm text-muted-foreground">
                                            ...
                                            <span className="font-medium">
                                                {format(parseISO(vehicle.updatedAt), "PP")}
                                            </span>
                                        </div>
                                        <div className="flex items-center justify-between">
                                            <span className="text-sm text-muted-foreground">
                ...
                <TabsContent value="fuel" className="mt-6">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Record of fuel purchases and consumption
                            </CardDescription>
                        </CardHeader>
                    ...
                    <Card>
                        ...
                        <CardContent className="min-h-[400px] flex items-center justify-center">
                            <div className="text-center">
                                ...
                                <h3 className="text-lg font-semibold mb-2">Coming Soon</h3>
                                <p className="text-muted-foreground">
                                    Maintenance history details will be available in a future
                                    update.
                                </p>
                            </div>
                        </CardContent>
                ...
                <TabsContent value="incidents" className="mt-6">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Record of incidents involving this vehicle
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="min-h-[400px] flex items-center justify-center">
                            <div className="text-center">
