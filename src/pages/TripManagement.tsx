...
import { Plus, PlusCircle, AlertTriangle, Route, Clock, CalendarDays, UserCheck } from "lucide-react"; // Adjusted icons
import { HasPermission } from "@/components/auth/HasPermission"; // Adjust path
import { TripRequestForm } from "@/components/trips/TripRequestForm"; // Adjust path
import { TripRequestsList } from "@/components/trips/TripRequestsList"; // Adjust path
import { useQuery } from "@tanstack/react-query";
import { apiClient, TripRequestDto, RequestStatus } from "@/lib/apiClient"; // Adjust path
import {
  Pagination,
  PaginationContent,
  PaginationEllipsis,
