...
import { ProjectStatus, Project, UpdateProjectDto } from "@/lib/apiClient";
...
export function EditProjectDialog({ open, onOpenChange, project, onSubmit, isSubmitting }: EditProjectDialogProps) {
                ...
                <FormItem>
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value={ProjectStatus.ON_GOING}>On Going</SelectItem>
                      <SelectItem value={ProjectStatus.ON_HOLD}>On Hold</SelectItem>
                      <SelectItem value={ProjectStatus.EXPIRED}>Expired</SelectItem>
                    </SelectContent>
                  </Select>
                  <FormMessage />
                </FormItem>
