...
import { CreateMaintenanceRequestDto } from "@/types/maintenance";
...
const formSchema = z.object({
    ...
    maintenanceTypeId: z.coerce.number().positive("Maintenance type is required"),
});
    ...
    const { data: vehiclesData, isLoading: isLoadingVehicles } = useQuery<PageResponse<VehicleDto>>(
        {
            ...
            queryFn: () => apiClient.vehicles.getAll({ page: 0, size: 1000 }), // Fetch a reasonable number for a dropdown
        }
    );

    const { data: maintenanceTypesData, isLoading: isLoadingMaintenanceTypes } = useQuery({
        queryKey: ["maintenanceTypes"],
        queryFn: () => apiClient.maintenance.types.getAll(), // This is a placeholder, needs a real endpoint
    });
        ...
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            ...
                            <FormControl>
                                <Input
                                    placeholder="e.g., Engine Overheating, Brake Replacement"
                                    {...field}
                                />
                            </FormControl>
                            <FormMessage />
                        ...
                        <FormItem>
                            ...
                            >
                                ...
                                <SelectContent>
                                    ...
                                    {(maintenanceTypesData as any)?.map((type: any) => (
                            ...
                            <FormDescription>
                                Select the type of maintenance required.
                            </FormDescription>
                            <FormMessage />
                        </FormItem>
                    )}
                ...
                <div className="flex justify-end gap-2 pt-4">
                    ...
                    <Button
                        type="submit"
                        disabled={loading || isLoadingVehicles || isLoadingMaintenanceTypes}
                    >
