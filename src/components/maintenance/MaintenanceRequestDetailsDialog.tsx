...
import { MaintenanceRequestDto, RequestStatus } from "@/lib/apiClient";
...
const DetailItem = ({ label, value, isBadge = false }: { label: string; value?: string | number | boolean | React.ReactNode | null; isBadge?: boolean; }) => (
      ...
      <DialogContent className="sm:max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <div className="py-4 space-y-3">
            <dl className="divide-y divide-gray-200 dark:divide-gray-700">
                <DetailItem label="Status" value={renderStatusBadge(request.status)} isBadge />
