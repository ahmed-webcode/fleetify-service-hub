...
import { ActionType, FuelRequestActionDto, FuelRequestDto } from "@/lib/apiClient";
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <Card className="border-0 shadow-none">
          ...
          <CardContent className="p-0 py-3">
            <div className="grid grid-cols-2 gap-2 text-sm">
              ...
              <div>{request.targetType === "VEHICLE" 
        ...
        <Tabs defaultValue="approve" className="w-full">
          <TabsList className="grid grid-cols-3 mb-4">
            <TabsTrigger value="approve" onClick={() => setActionType(ActionType.APPROVE)}>
              Approve
            </TabsTrigger>
            <TabsTrigger value="modify" onClick={() => setActionType(ActionType.APPROVE_WITH_MODIFICATION)}>
              Modify
            </TabsTrigger>
            <TabsTrigger value="reject" onClick={() => setActionType(ActionType.REJECT)}>
              Reject
            </TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="approve">
            <div className="space-y-4">
              ...
              <div className="text-sm text-muted-foreground">
                Approving will grant the full requested amount of {request.requestedAmount} liters.
              </div>
            </div>
          </TabsContent>
