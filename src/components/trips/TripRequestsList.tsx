...
import { TripRequestDto, RequestStatus } from "@/lib/apiClient";
          ...
          <TableBody className="divide-y divide-border">
            {requests.map((request) => (
              <TableRow key={request.id} className="hover:bg-muted/30">
                ...
                <TableCell className="font-medium max-w-[200px] truncate" title={request.purpose}>{request.purpose}</TableCell>
                ...
                <TableCell className="text-right">
                    <HasPermission permission="manage_trip_requests" fallback={
